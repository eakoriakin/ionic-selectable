...
| `virtualScrollHeaderFn`           | --                                    | See Ionic VirtualScroll [headerFn](https://ionicframework.com/docs/api/virtual-scroll). See more on [GitHub](https://github.com/eakoriakin/ionic-selectable/wiki/Documentation#virtualscrollheaderfn).                                                                                                                                                                                                         | `(item: any, index: number, items: any[]) => string`                                  | `() => null`                                              |
